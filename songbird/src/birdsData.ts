import { BirdsDataOptions } from './interfaces/interfaces';

const birdsData: BirdsDataOptions[][] = [
	[
		{
			id: 1,
			name: 'Ворон',
			...
			description_en:
				'The raven is a large bird. Their body length reaches 70 centimeters, and their wingspan is up to one and a half meters. Ravens inhabit the vicinity of the Tower. There is a belief in England that on the day when black crows fly away from the Tower, the monarchy will collapse.',
		...
		},
		{
			...
			description_en:
				'The sounds the crane makes are similar to the resounding "kur-ly - kur-ly. Cranes most often sing a duet - one bird starts the chorus with the syllable "kur" and the other picks up the "li". If the bird sings alone, it makes only the "kur" sound.',
		...
		},
		{
			...
			description_en:
				'Swallows are characterized by soft chirping. The songs of swallows do not cease throughout the summer. Researchers distinguish up to six chirping sounds in birds: "vith", "vith-vith", "chivit", "chirivit", etc. Swallows like to sing a duet.',
		...
		},
		{
			...
			description_en:
				'The nightjar is an inconspicuous bird known for its voice. The song of the nightjar sounds like a monotonous trill similar to the rattle of a motorcycle. This rattling can be heard from dusk to dawn, its tonality, frequency and volume varying.',
		...
		},
		{
			...
			description_en:
				'The cuckoo is so named because of the peculiarities of its songs. The sonorous "cuckoo" cannot be confused with any other bird. Cuckoos do not build nests, their offspring are raised by other species of birds, to which cuckoos drop their eggs.',
		...
		},
		{
			...
			description_en:
				'More than 40 different sound combinations can be distinguished in the chirping of tits. They sing practically the whole year round, only quieting down a bit in winter. Tits are real forest sanitarians. One pair of tits protects dozens of trees from pests during the nesting period.',
	...
	[
		{
			...
			description_en:
				'Sparrows are the most famous and recognizable birds. They are easily recognized by their colorful plumage and cheerful chirping. Sparrows are a synatropic species - they settle close to human habitation.',
		...
		},
		{
			...
			description_en:
				'Rooks are very smart and intelligent birds. They use their beak to create and use simple tools. Rooks have a reflex to the sounds of a tractor. When they hear a "clatter", they fly to the sound - the tractor is plowing the ground, which means there is a lot of food in the area.',
		...
		},
		{
			...
			description_en:
				'The word "галка" comes from the Old Slavic language and is translated as "black". Ravens or other black birds are often called with this word. The Latin name of an jackdaw "monedula" is associated with the word coin for the bird\'s love of shiny and bright things.',
		...
		},
		{
			...
			description_en:
				'The thrush is the best singer of the passerine family. The song consists only of beautiful sonorous whistles and short trills. Most often it can be heard in the morning and evening hours. Thrushes sing during the entire nesting period.',
		...
		},
		{
			...
			description_en:
				'A magpie is a very industrious bird. She builds up to eight nests, and then chooses the best of them. The entrance to the magpie\'s nest always faces south, so that the dwelling will be warmer. Magpies are the only birds that recognize themselves in the mirror.',
	...
	[
		{
			...
			description_en:
				'There are 450 species of finches in the wild. In winter, finches lead a gregarious lifestyle. Sometimes sparrows can be seen in their families. Finches sing in spring, with the onset of their mating season. Their singing is a rousing, minute-long roulade.',
		...
		},
		{
			...
			description_en:
				'Crossbills are called "Christmas" birds. Under natural conditions, they give birth in winter, in January. These birds insulate their nests with moss and animal hairs, so the chicks are not cold. In search of cones, crossbills can fly 3500 km away from the nest.',
		...
		},
		{
			...
			description_en:
				'The turtledove lives in mixed and broad-leaved forests, as well as in urban parks and townships. Birds often choose to live near people and easily get used to people. Because of their melodious, pleasant singing, turtledoves are often raised in homes.',
		...
		},
		{
			...
			description_en:
				'The woodpecker is a conspicuous and noisy bird, often living close to humans. From mid-January to the end of June you can hear the "drumming" of woodpeckers - a trill from the vibration of branches under the rapid blows of the bird\'s beak. In good weather the drumming can be heard within a radius of 1.5 km.',
		...
		},
		{
			...
			description_en:
				'Hoopoe prefer to live in open landscapes with isolated trees or groves. Forest-steppe and savannah are the most convenient for the bird. The hoopoe may choose to live near humans: pastures, vineyards, orchards.',
		...
		},
		{
			...
			description_en:
				'Swifts can be seen in almost every corner of the planet. They live both in forest areas and in open areas. Swifts live in large flocks. Large colonies of these birds can be seen in cities or on coastal cliffs.',
	...
	[
		{
			...
			description_en:
				'Larks are migratory birds. From the beginning of September, they fly south. They come back at the beginning of March, regardless of whether snow has melted or not. The arrival of the skylarks was used to determine the arrival of spring and the time when it was time to plow the land.',
		...
		},
		{
			...
			description_en:
				'Nightingales sing from early May until the end of summer. Each nightingale song consists of 12 repetitive elements, which are also called knees. In addition to their own trills, nightingales easily and well adopt the singing of other birds.',
		...
		},
		{
			...
			description_en:
				'Starlings are migratory birds. The synchronized flight of large flocks of starlings is called murmuration. It is a beautiful and mesmerizing phenomenon - many birds seem to dance in the air, forming intricate figures that decrease and increase in the sky.',
		...
		},
		{
			...
			description_en:
				'The oriole\'s melodious voice has been compared to the sound of a flute. It is difficult for humans to see the oriole, as it lives high up in the trees. The oriole is not only a very beautiful bird, but also a useful one. It destroys poisonous caterpillars that other birds do not eat.',
		...
		},
		{
			...
			description_en:
				'Whistleblowers have very tenacious claws, which help the bird stay on branches and nibble on berries, which are the hardest to reach. During courtship, the male offers the female a berry or other treat. If the female accepts it, the birds create a pair.',
		...
		},
		{
			...
			description_en:
				'Goldfinches sing beautifully and melodically. Both in nature and in captivity, they chirp almost all year round. More than 20 iridescent trills can be distinguished in the twittering. Goldfinches get used to people and can even return to the owner after being released into the wild',
	...
	[
		...
		},
		{
			...
			description_en:
				'Vultures are large raptors, about half a meter tall and weighing up to 1 kg as adults. Their wings are narrow and long, with a wingspan of 1.5 m. Vultures often nest in large flocks and even form large colonies.',
		...
		},
		{
			...
			description_en:
				'The lun is a small falcon. It feeds mainly on rodents; voles, hamsters, and mice are the basis of its diet. The plumage of the lun may be ash-gray. The comparison "gray as a lun" is associated with such a bird.',
		...
		},
		{
			...
			description_en:
				'The Latin name Falco is derived from the word "sickle" because of the sickle shape of its wings. The long and wide wings allow the falcon to fly high into the sky and soar freely. Falcon flight speeds reach 280-320 kilometers per hour.',
		...
		},
		{
			...
			description_en:
				'All hawks are characterized by wide and short wings. Another distinctive feature is the white "eyebrows" above the eyes. Slavic vigilantes placed the image of a hawk on their banners as a symbol of bravery, power and ruthlessness to enemies.',
		...
		},
		{
			...
			description_en:
				'The flight of an owl is silent and its vision is very sharp. These features make the bird a consummate night hunter. The eagle owl has no natural enemies, no animal hunts adult birds. But baby-owls are attacked by foxes and wolves.',
	...
	[
		{
			...
			description_en:
				'The albatross is the largest flying bird in the world. It has a wingspan of three and a half and weighs ten kilograms. Albatrosses spend most of their lives in the air, covering vast distances over the ocean.',
		...
		},
		{
			...
			description_en:
				'The blue-footed booby\'s special feature is not only the rich bright blue color of its feet, but also the fact that they are very warm. While other birds warm their clutches with their bodies, the blue-footed booby does it with its paws.',
		...
		},
		{
			...
			description_en:
				'The size of petrels varies. The smallest of them are up to 25 cm in length, the largest up to 1 m, with a wingspan of about 2 m. There is a belief that the appearance of the petrel in the air heralds a storm, as the name of the bird itself indicates.',
		...
		},
		{
			...
			description_en:
				'Pelicans are inhabitants of seas and rivers. They walk clumsily, but they fly and swim well. They feed mainly on fish, arrange collective hunts - lining up in a semicircle they flap the water with their wings and beaks and drive frightened fish out into shallow water.',
		...
		},
		{
			...
			description_en:
				'The male Emperor penguin reaches a height of 130 cm and its weight can approach 50 kg. Of all modern penguins, this species is the largest. The penguin\'s diet consists of fish, squid and krill. The birds hunt in the ocean in large groups.',
		...
		},
		{
			...
			description_en:
				'Seagulls inhabit the shores of seas, lakes, rivers, reservoirs, swamps, often nesting on islands. Since the end of the last century, seagulls began to appear in large cities, where they make nests on the roofs of buildings. All gulls lead a colonial lifestyle.',
