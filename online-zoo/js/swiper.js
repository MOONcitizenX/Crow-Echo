	...
	function o(e) {
		...
		if (t) {
			...
			if ((i.indexOf(e) < 0 && i.unshift(e), $(t).is(a))) r.apply(t, i);
				...
				for (var s = $(t).parents(), n = 0; n < s.length; n += 1)
					$(s[n]).is(a) && r.apply(s[n], i);
		}
	}
	function l(e) {
...
function trigger() {
	for (
		var e = getWindow(), t = arguments.length, i = new Array(t), s = 0;
		s < t;
		s++
	)
		i[s] = arguments[s];
	...
	for (
		...
		if (null != i)
			for (
				...
				void 0 !== o &&
					o.enumerable &&
					(isObject$1(e[n]) && isObject$1(i[n])
						? extend$1(e[n], i[n])
						: !isObject$1(e[n]) && isObject$1(i[n])
						? ((e[n] = {}), extend$1(e[n], i[n]))
						: (e[n] = i[n]));
			}
	}
	return e;
...
function calcDevice(e) {
	...
	return (
		!h &&
			...
			(v = !1)),
		d && !c && ((n.os = 'android'), (n.android = !0)),
		(h || u || p) && ((n.os = 'ios'), (n.ios = !0)),
		n
	);
}
...
function updateSlides() {
	...
	if (void 0 !== s) {
		...
		for (
			...
			if (t.slidesPerColumn > 1) {
				...
				if ('row' === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
					var D = Math.floor(
						...
						O = P - t.slidesPerColumn * t.slidesPerGroup * D,
						A =
							0 === D
								? t.slidesPerGroup
								: Math.min(
										Math.ceil(
											(d - D * S * t.slidesPerGroup) / S
										),
										t.slidesPerGroup
								  );
					(k =
			...
			if ('none' !== z.css('display')) {
				if ('auto' === t.slidesPerView) {
					var N = e.getComputedStyle(z[0], null),
						G = z[0].style.transform,
						B = z[0].style.webkitTransform;
					if (
						(G && (z[0].style.transform = 'none'),
						...
						if (R && 'border-box' === R) T = H + X + _;
						else {
							var Y = z[0],
								V = Y.clientWidth;
							T = H + W + F + X + _ + (Y.offsetWidth - V);
						}
					} else {
						var q = parseFloat(N.getPropertyValue('height') || 0),
							j = parseFloat(
							...
							K = parseFloat(
								N.getPropertyValue('margin-top') || 0
							),
							Z = parseFloat(
								N.getPropertyValue('margin-bottom') || 0
							),
							J = N.getPropertyValue('box-sizing');
						if (J && 'border-box' === J) T = q + K + Z;
						else {
							var Q = z[0],
								ee = Q.clientHeight;
							T = q + j + U + K + Z + (Q.offsetHeight - ee);
						}
					}
					...
					(T = (s - (t.slidesPerView - 1) * w) / t.slidesPerView),
						t.roundLengths && (T = Math.floor(T)),
						l[P] &&
							(this.isHorizontal()
		...
		if (
			...
			t.slidesPerColumn > 1 &&
				((this.virtualSize = (T + t.spaceBetween) * E),
				(this.virtualSize =
			...
			for (var te = 0; te < h.length; te += 1) {
				...
				t.roundLengths && (ie = Math.floor(ie)),
					h[te] < this.virtualSize + h[0] && C.push(ie);
			}
			h = C;
		}
		if (!t.centeredSlides) {
			...
			for (var se = 0; se < h.length; se += 1) {
				...
				t.roundLengths && (ae = Math.floor(ae)),
					h[se] <= this.virtualSize - s && C.push(ae);
			}
			(h = C),
		...
		if (
			...
			0 !== t.spaceBetween &&
				(this.isHorizontal()
					? a
						? l.filter(c).css({ marginLeft: w + 'px' })
						: l.filter(c).css({ marginRight: w + 'px' })
					: l.filter(c).css({ marginBottom: w + 'px' })),
			...
			var ne = (re -= t.spaceBetween) - s;
			h = h.map(function (e) {
				return e < 0 ? -v : e > ne ? ne + f : e;
			});
		}
...
function updateProgress(e) {
	...
	0 === s
		...
		extend$1(this, { progress: a, isBeginning: r, isEnd: n }),
...
function slideTo(e, t, i, s) {
	...
	if (o.cssMode) {
		var b,
			y = r.isHorizontal(),
			x = -g;
		if ((u && (x = c.scrollWidth - c.offsetWidth - x), 0 === t))
			c[y ? 'scrollLeft' : 'scrollTop'] = x;
		else if (c.scrollTo)
			c.scrollTo(
				(((b = {})[y ? 'left' : 'top'] = x), (b.behavior = 'smooth'), b)
			);
		else c[y ? 'scrollLeft' : 'scrollTop'] = x;
		return !0;
	}
	return (
		0 === t
...
function loopCreate() {
	...
	a.each(function (t, i) {
		...
		i < e.loopedSlides && d.push(t),
			i < a.length && i >= a.length - e.loopedSlides && l.push(t),
			s.attr('data-swiper-slide-index', i);
	});
	for (var h = 0; h < d.length; h += 1)
		s.append($(d[h].cloneNode(!0)).addClass(i.slideDuplicateClass));
	for (var p = l.length - 1; p >= 0; p -= 1)
		s.prepend($(l[p].cloneNode(!0)).addClass(i.slideDuplicateClass));
}
function loopFix() {
				...
				if (
					...
					if (void 0 === i.isScrolling)
						...
						(this.isVertical() && a.currentX === a.startX)
							...
							: h * h + p * p >= 25 &&
							  ((u =
									(180 *
										Math.atan2(Math.abs(p), Math.abs(h))) /
									Math.PI),
					...
					if (
						...
						if (
							...
							c > 0 && i.currentTranslate > this.minTranslate()
								? ((v = !1),
								  s.resistance &&
										(i.currentTranslate =
											this.minTranslate() -
	...
	if (
		...
		if (s.freeMode) {
				...
				if (i.velocities.length > 1) {
					...
					(t.velocity = f / m),
						...
						Math.abs(t.velocity) < s.freeModeMinimumVelocity &&
							(t.velocity = 0),
						(m > 150 || now() - c.time > 300) && (t.velocity = 0);
				} else t.velocity = 0;
			...
			for (
				...
				k < o.length;
				k += k < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup
			) {
				...
				void 0 !== o[k + L]
					? h >= o[k] &&
					  ...
					  ((P = k), (z = o[k + L] - o[k]))
					: h >= o[k] &&
					  ((P = k), (z = o[o.length - 1] - o[o.length - 2]));
			}
			var I = (h - o[P]) / z,
...
function loadImage(e, t, i, s, a, r) {
	...
	$(e).parent('picture')[0] || (e.complete && a)
		? l()
		: t
	...
	Swiper = (function () {
		function e() {
			...
			(n.support = getSupport()),
				(n.device = getDevice({ userAgent: i.userAgent })),
			...
			n.useParams(o),
				(n.params = extend$1({}, o, extendedDefaults, i)),
				(n.originalParams = extend$1({}, n.params)),
				(n.passedParams = extend$1({}, i)),
				n.params &&
					n.params.on &&
		...
		return (
			...
			(e.installModule = function (t) {
				...
				var i =
					t.name ||
					Object.keys(e.prototype.modules).length + '_' + now();
...
var Virtual = {
		update: function (e) {
			...
			if (
				...
				return (
					t.slidesGrid !== c && E !== f && t.slides.css(m, E + 'px'),
	...
	Keyboard = {
				...
				this.isHorizontal()
					? ((o || l || d || h) &&
							(a.preventDefault
								? a.preventDefault()
								: (a.returnValue = !1)),
					  (((l || h) && !s) || ((o || d) && s)) && this.slideNext(),
					  (((o || d) && !s) || ((l || h) && s)) && this.slidePrev())
					: ((o || l || p || u) &&
							(a.preventDefault
								? a.preventDefault()
								: (a.returnValue = !1)),
		...
		enable: function () {
			...
			this.keyboard.enabled ||
				($(e).on('keydown', this.keyboard.handle),
				(this.keyboard.enabled = !0));
		},
		disable: function () {
			var e = getDocument();
			this.keyboard.enabled &&
				($(e).off('keydown', this.keyboard.handle),
		...
		handle: function (e) {
			...
			if (
				('container' !== i.params.mousewheel.eventsTarget &&
					(a = $(i.params.mousewheel.eventsTarget)),
				!i.mouseEntered &&
					...
					if (
						...
						if (
							...
							(i.mousewheel.lastEventBeforeSnap = l),
								v.splice(0),
								(i.mousewheel.timeout = nextTick(function () {
									i.slideToClosest(
										i.params.speed,
										!0,
										void 0,
		...
		enable: function () {
			...
			return (
				'container' !== this.params.mousewheel.eventsTarget &&
					(t = $(this.params.mousewheel.eventsTarget)),
					...
					if (
						(t.dynamicBullets &&
							...
							(l =
								((o =
									n +
									(Math.min(d.length, t.dynamicMainBullets) -
										1)) +
									n) /
								2)),
						d.removeClass(
		...
		on: {
			...
			click: function (e, t) {
				e.params.pagination.el &&
					...
					!$(t.target).hasClass(e.params.pagination.bulletClass) &&
					(!0 ===
		...
		init: function () {
			if (this.params.scrollbar.el) {
				...
				0 === a.length &&
					...
					s.append(a)),
					extend$1(e, { $el: s, el: s[0], $dragEl: a, dragEl: a[0] }),
		...
		onGestureStart: function (e) {
			...
			if (
				...
				(s.fakeGestureTouched = !0),
					(a.scaleStart = Zoom.getDistanceBetweenTouches(e));
			}
			(a.$slideEl && a.$slideEl.length) ||
			((a.$slideEl = $(e.target).closest('.' + this.params.slideClass)),
			0 === a.$slideEl.length &&
		...
		onGestureChange: function (e) {
			...
			if (!t.gestures) {
				...
				(s.fakeGestureMoved = !0),
					(a.scaleMove = Zoom.getDistanceBetweenTouches(e));
			}
	...
	A11y = {
		...
		init: function () {
			...
			e.a11y.addElId(n, o),
				...
				e.a11y.addElRole($(e.slides), 'group'),
				e.slides.each(function (t) {
					var i = $(t);
					e.a11y.addElLabel(
						i,
	...
	History = {
		init: function () {
			...
			if (this.params.history) {
				...
				var t = this.history;
				(t.initialized = !0),
					(t.paths = History.getPathValues(this.params.url)),
		...
		setHistory: function (e, t) {
			...
			if (this.history.initialized && this.params.history.enabled) {
				...
				var a = this.slides.eq(t),
					r = History.slugify(a.attr('data-history'));
		...
		scrollToSlide: function (e, t, i) {
			if (t)
				for (var s = 0, a = this.slides.length; s < a; s += 1) {
					...
					if (
						History.slugify(r.attr('data-history')) === t &&
			...
			if (
				...
				if (i)
					for (var s = 0, a = this.slides.length; s < a; s += 1) {
						var r = this.slides.eq(s);
						if (
							(r.attr('data-hash') || r.attr('data-history')) ===
								i &&
							!r.hasClass(this.params.slideDuplicateClass)
						) {
							var n = r.index();
				...
				this.params.hashNavigation.watchState &&
					$(t).on('hashchange', this.hashNavigation.onHashCange);
			}
		},
		destroy: function () {
			var e = getWindow();
	...
	Coverflow = {
		setTranslate: function () {
			for (
				...
				var u = i.eq(h),
					c = s[h],
					v = ((o - u[0].swiperSlideOffset - c / 2) / c) * a.modifier,
					f = r ? l * v : 0,
					m = r ? 0 : l * v,
					g = -d * Math.abs(v),
					w = a.stretch;
			...
			return (
				e.swiper instanceof t
					? ((this.thumbs.swiper = e.swiper),
					  extend$1(this.thumbs.swiper.originalParams, {
							watchSlidesProgress: !0,
							slideToClickedSlide: !1
					  }),
